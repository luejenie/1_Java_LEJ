...
public class StudentView {
	...
	public void displayMenu() {
		...
		do {
			...
			try {
				...
				sc.nextLine(); // 입력 버퍼에 남아있는 잘못된 문자열을 꺼내와 제거 _ 안할 경우 무한 루프에 빠짐.
			}
	...
	public void selectAll() {
		...
		for(int i=0; i<stdList.size(); i++) {
			System.out.println( stdList.get(i)/*.toString*/ );  //자동으로 붙여짐
		}
		...
		for( Student s : stdList ) {   //위 일반 for문과 같음
	...
	public void selectStudent1() {
		...
		if( resultList.isEmpty()) {   
			...
			System.out.println("검새 결과가 없습니다.");
