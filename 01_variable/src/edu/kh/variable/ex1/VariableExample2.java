...
public class VariableExample2 {
	...
	public static void main(String[] args) {
		...
		booleanData = false;
		// boolean 자료형 변수는 true / false 값만 저장할 수 있다.
		...
		// -> long 자료형의 리터럴 표기법은 정수 뒤에 L 또는 l 을 작성.
		...
		//ch1 = A;  //오류
		ch1 = 'A';
		// char의 리터럴 표기법은 ' '(홑따옴표)  _한 글자니까 따옴표도 하나
		
		ch2 = 66;  // 'B'를 뜻함.
		// char 자료형은 숫자-문자 연결된 형태의 문자표에서
		// 일치하는 문자나 숫자의 문자 부분만 출력함.
