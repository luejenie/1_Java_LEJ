...
public class StudentManagementView {
	...
	public void displayMenu() {
		...
		do {
			...
			System.out.println("5. 학생 정보 수정(이름 검색)");  // 점수 수정
	...
	public void updateStudent() {
		...
		int result = service.updateStudent(idx, kor, eng, math);  //result == -1 || 0 || 1
		
		if(result == -1) {
			System.out.println("입력한 값이 인데스 범위를 초과했습니다.");
