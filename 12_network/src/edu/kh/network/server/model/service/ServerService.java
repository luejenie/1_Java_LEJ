...
//			6) 보조 스트림을 통해 성능 개선
			br = new BufferedReader(new InputStreamReader(is));   // BufferReader는 문자기반, is는 바이트기반. 
			// 문자 기반 BufferedReader와
			// 바이트 기반 InputStream을 연결할 수 있도록  _이에 is를 바로 쓰면 안되고 확장공사해줘야함.
			// InputStreamReader를 사용    _  reader라는 이름부터 문자기반.
...
//			  2022년 08월 26일 15:30:21 [서버 접속 성공]
			...
			pw.flush(); // flush() : 스트림의 내용을 밀어냄     cf. close(): 밀어내고 닫음
